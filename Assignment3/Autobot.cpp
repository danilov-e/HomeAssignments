...
unsigned int Autobot::getCourage()
{
    return _courage;
}
void Autobot::setCourage(unsigned int courage)
{
    _courage = courage;
}
unsigned int Autobot::getTeamBonus()
{
    return _teamBonus;
}
void Autobot::setTeamBonus(unsigned int teamBonus)
{
