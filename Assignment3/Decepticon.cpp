...
unsigned int Decepticon::getCunning()
{
    return _cunning;
}
void Decepticon::setCunning(unsigned int cunning)
{
    _cunning = cunning;
}
unsigned int Decepticon::getStealthLevel()
{
    return _stealthLevel;
}
void Decepticon::setStealthLevel(unsigned int stealthLevel)
{
